...
class Client:
    ...
    async def disconnect(self) -> None:
        ...
        """
        ...
    async def invoke(self, request: TLRequest) -> TLObject:
        """
    ...
    async def resolve_peer(self, peer: hints.InputPeerLike) -> hints.Peer:
        ...
        """
        ...
    async def resolve_peer_ref(self, peer: hints.InputPeerLike) -> PeerRef:
        """
        Resolves any InputPeerLike into a PeerRef.
    ...
    def _is_event_pool_running(self) -> bool: ...
    async def _start_event_pool(self) -> None: ...
    async def _stop_event_pool(self) -> None: ...
    def add_handler(self, event, handler) -> None: ...
