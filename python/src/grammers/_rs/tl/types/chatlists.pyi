...
@final
class ChatlistInvite(TLObject, TLRequest):
    """
...
@final
class ChatlistInviteAlready(TLObject, TLRequest):
    """
...
@final
class ChatlistUpdates(TLObject, TLRequest):
    """
...
@final
class ExportedInvites(TLObject, TLRequest):
    """
