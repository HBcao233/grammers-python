...
@final
class Albums(TLObject, TLRequest):
    """
...
@final
class AlbumsNotModified(TLObject, TLRequest):
    """
...
@final
class AllStories(TLObject, TLRequest):
    """
...
@final
class AllStoriesNotModified(TLObject, TLRequest):
    """
...
@final
class CanSendStoryCount(TLObject, TLRequest):
    """
...
@final
class FoundStories(TLObject, TLRequest):
    """
...
@final
class Stories(TLObject, TLRequest):
    """
...
@final
class StoryReactionsList(TLObject, TLRequest):
    """
...
@final
class StoryViewsList(TLObject, TLRequest):
    """
    ...
    def __new__(
        ...
        reactions_count: int,
        views: Sequence[
            types.StoryView | types.StoryViewPublicForward | types.StoryViewPublicRepost
        ],
        chats: Sequence[
            types.ChatEmpty
            | types.Chat
