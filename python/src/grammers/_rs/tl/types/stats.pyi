...
class BroadcastStats(TLObject):
    ...
    def __new__(
        ...
        followers_graph: types.StatsGraphAsync
        | types.StatsGraphError
        | types.StatsGraph,
        mute_graph: types.StatsGraphAsync | types.StatsGraphError | types.StatsGraph,
        top_hours_graph: types.StatsGraphAsync
        | types.StatsGraphError
        | types.StatsGraph,
        interactions_graph: types.StatsGraphAsync
        | types.StatsGraphError
        | types.StatsGraph,
        iv_interactions_graph: types.StatsGraphAsync
        | types.StatsGraphError
        | types.StatsGraph,
        views_by_source_graph: types.StatsGraphAsync
        | types.StatsGraphError
        | types.StatsGraph,
        new_followers_by_source_graph: types.StatsGraphAsync
        | types.StatsGraphError
        | types.StatsGraph,
        languages_graph: types.StatsGraphAsync
        | types.StatsGraphError
        | types.StatsGraph,
        reactions_by_emotion_graph: types.StatsGraphAsync
        | types.StatsGraphError
        | types.StatsGraph,
        story_interactions_graph: types.StatsGraphAsync
        | types.StatsGraphError
        | types.StatsGraph,
        story_reactions_by_emotion_graph: types.StatsGraphAsync
        | types.StatsGraphError
        | types.StatsGraph,
        recent_posts_interactions: Sequence[
...
class MegagroupStats(TLObject):
    ...
    def __new__(
        ...
        new_members_by_source_graph: types.StatsGraphAsync
        | types.StatsGraphError
        | types.StatsGraph,
        languages_graph: types.StatsGraphAsync
        | types.StatsGraphError
        | types.StatsGraph,
        messages_graph: types.StatsGraphAsync
        | types.StatsGraphError
        | types.StatsGraph,
        ...
        | types.StatsGraphError
        | types.StatsGraph,
        weekdays_graph: types.StatsGraphAsync
        | types.StatsGraphError
        | types.StatsGraph,
