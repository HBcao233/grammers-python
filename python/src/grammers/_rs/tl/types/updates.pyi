...
@final
class ChannelDifference(TLObject, TLRequest):
    """
...
@final
class ChannelDifferenceEmpty(TLObject, TLRequest):
    """
...
@final
class ChannelDifferenceTooLong(TLObject, TLRequest):
    """
...
@final
class Difference(TLObject, TLRequest):
    """
    ...
    def __new__(
        ...
        new_encrypted_messages: Sequence[
            types.EncryptedMessage | types.EncryptedMessageService
        ],
        other_updates: Sequence[
            types.UpdateNewMessage
            | types.UpdateMessageId
...
@final
class DifferenceEmpty(TLObject, TLRequest):
    """
...
@final
class DifferenceSlice(TLObject, TLRequest):
    """
...
@final
class DifferenceTooLong(TLObject, TLRequest):
    """
...
@final
class State(TLObject, TLRequest):
    """
