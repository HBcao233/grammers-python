...
class CheckUsername(TLRequest):
    """
    [Read `bots.checkUsername` docs](https://core.telegram.org/method/bots.checkUsername).
...
@final
class ExportBotToken(TLRequest):
    """
...
@final
class RequestWebViewButton(TLRequest):
    """
...
@final
class GetRequestedWebViewButton(TLRequest):
    """
...
@final
class GetAccessSettings(TLRequest):
    """
...
@final
class EditAccessSettings(TLRequest):
    """
    [Read `bots.editAccessSettings` docs](https://core.telegram.org/method/bots.editAccessSettings).
