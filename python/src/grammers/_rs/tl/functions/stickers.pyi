...
@final
class AddStickerToSet(TLObject, TLRequest):
    """
...
@final
class ChangeSticker(TLObject, TLRequest):
    """
...
@final
class ChangeStickerPosition(TLObject, TLRequest):
    """
...
@final
class CreateStickerSet(TLObject, TLRequest):
    """
...
@final
class RemoveStickerFromSet(TLObject, TLRequest):
    """
...
@final
class RenameStickerSet(TLObject, TLRequest):
    """
...
@final
class ReplaceSticker(TLObject, TLRequest):
    """
...
@final
class SetStickerSetThumb(TLObject, TLRequest):
    """
...
@final
class SuggestShortName(TLObject, TLRequest):
    """
