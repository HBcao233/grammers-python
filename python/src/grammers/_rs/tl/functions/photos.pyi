...
@final
class DeletePhotos(TLObject, TLRequest):
    """
...
@final
class GetUserPhotos(TLObject, TLRequest):
    """
...
@final
class UpdateProfilePhoto(TLObject, TLRequest):
    """
...
@final
class UploadContactProfilePhoto(TLObject, TLRequest):
    """
...
@final
class UploadProfilePhoto(TLObject, TLRequest):
    """
