...
class ReportReaction(TLRequest):
    ...
    def __new__(
        ...
        | types.InputPeerChannelFromMessage,
        id: int,
        reaction_peer: types.InputPeerEmpty
        | types.InputPeerSelf
        | types.InputPeerChat
        | types.InputPeerUser
        | types.InputPeerChannel
...
class ReadSavedHistory(TLRequest):
    ...
    def __new__(
        cls,
        parent_peer: types.InputPeerEmpty
        | types.InputPeerSelf
        | types.InputPeerChat
        | types.InputPeerUser
        | types.InputPeerChannel
...
@final
class EditChatCreator(TLRequest):
    """
...
@final
class GetFutureChatCreatorAfterLeave(TLRequest):
    """
...
@final
class EditChatParticipantRank(TLRequest):
    """
...
@final
class DeclineUrlAuth(TLRequest):
    """
    [Read `messages.declineUrlAuth` docs](https://core.telegram.org/method/messages.declineUrlAuth).
...
@final
class CheckUrlAuthMatchCode(TLRequest):
    """
    [Read `messages.checkUrlAuthMatchCode` docs](https://core.telegram.org/method/messages.checkUrlAuthMatchCode).
...
@final
class ComposeMessageWithAi(TLRequest):
    """
...
@final
class ReportReadMetrics(TLRequest):
    """
    [Read `messages.reportReadMetrics` docs](https://core.telegram.org/method/messages.reportReadMetrics).
    ...
    def __new__(
        ...
        | types.InputPeerUserFromMessage
        | types.InputPeerChannelFromMessage,
        metrics: Sequence[types.InputMessageReadMetric],
    ) -> Self: ...
    def to_dict(self) -> dict: ...

@final
class ReportMusicListen(TLRequest):
    """
    [Read `messages.reportMusicListen` docs](https://core.telegram.org/method/messages.reportMusicListen).
...
@final
class DeletePollAnswer(TLRequest):
    """
...
@final
class GetUnreadPollVotes(TLRequest):
    """
...
@final
class SetBotGuestChatResult(TLRequest):
    """
...
@final
class DeleteParticipantReactions(TLRequest):
    """
    [Read `messages.deleteParticipantReactions` docs](https://core.telegram.org/method/messages.deleteParticipantReactions).
...
@final
class DeleteParticipantReaction(TLRequest):
    """
...
@final
class GetPersonalChannelHistory(TLRequest):
    """
