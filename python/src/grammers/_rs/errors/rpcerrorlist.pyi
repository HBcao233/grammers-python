...
class TwoFaConfirmWaitError(FloodError):
    ...
    """
    def __new__(
        cls, name: str, value: int | None = None, caused_by: int | None = None
    ): ...
...
class ConnectionSystemLangCodeEmptyError(BadRequestError):
    """
    The system language str was empty during connection
    """
    def __new__(
        cls, name: str, value: int | None = None, caused_by: int | None = None
    ): ...
...
class EntityBoundsInvalidError(BadRequestError):
    """
    Some of provided entities have invalid bounds (length is zero or out of the boundaries of the str)
    """
    def __new__(
        cls, name: str, value: int | None = None, caused_by: int | None = None
    ): ...
