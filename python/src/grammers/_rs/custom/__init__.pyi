...
class RestrictionReason:
    ...
    """
    def __new__(cls, reason: enums.RestrictionReason): ...
    @property
...
class User(TLObject):
    ...
    """
    def __new__(cls, user: enums.User): ...
    @property
    def id(self) -> PeerId: ...
    @property
    ...
    @property
    def photo(self) -> enums.UserProfilePhoto | None: ...
    @property
    def status(self) -> enums.UserStatus | None: ...
    @property
    ...
    @property
    def emoji_status(self) -> enums.EmojiStatus | None: ...
    @property
    def usernames(self) -> list[enums.Username]: ...
    @property
    def stories_max_id(self) -> enums.RecentStory | None: ...
    @property
    def color(self) -> enums.PeerColor | None: ...
    @property
    def profile_color(self) -> enums.PeerColor | None: ...
    @property
...
class Group(TLObject):
    ...
    def noforwards(self) -> bool | None:
        ...
        ...
    @property
    def photo(self) -> enums.ChatPhoto | None: ...
    @property
    def participants_count(self) -> int | None: ...
    @property
    def version(self) -> int | None: ...
    @property
    def migrated_to(self) -> enums.InputChannel | None: ...
    @property
    def admin_rights(self) -> enums.ChatAdminRights | None: ...
    @property
    def default_banned_rights(self) -> enums.ChatBannedRights | None: ...
    @property
    ...
    @property
    def banned_rights(self) -> enums.ChatBannedRights | None: ...
    @property
    def usernames(self) -> list[enums.Username]: ...
    @property
    def stories_max_id(self) -> enums.RecentStory | None: ...
...
class Channel(TLObject):
    ...
    """
    def __new__(cls, channel: enums.Chat) -> Self: ...
    @property
    def id(self) -> PeerId: ...
    @property
    def title(self) -> str:
...
class Message(TLObject):
    ...
    """
    def __new__(
        cls, client: Client, message: enums.Message, peers: PeerMap
    ) -> Self: ...
    @property
    ...
    def sender_id(self) -> PeerId | None:
        ...
        ...
    @property
    def sender(self) -> hints.Peer | None:
        """
    ...
    def saved_peer_id(self) -> PeerId | None:
        ...
        ...
    @property
    def fwd_from(self) -> enums.MessageFwdHeader | None:
        """
    ...
    def via_business_bot_id(self) -> int | None:
        ...
        ...
    @property
    def reply_to(self) -> enums.MessageReplyHeader | None:
        """
    ...
    def date_timestamp(self) -> int | None:
        ...
        ...
    @property
    def action(self) -> enums.MessageAction | None:
        """
    ...
    def message(self) -> str | None:
        ...
        ...
    @property
    def media(self) -> enums.MessageMedia | None:
        """
        ...
        ...
    @property
    def reply_markup(self) -> enums.ReplyMarkup | None:
        """
        ...
        ...
    @property
    def entities(self) -> enums.MessageEntity | None:
        """
    ...
    def forwards(self) -> int | None:
        ...
        ...
    @property
    def replies(self) -> enums.MessageReplies | None:
        """
    ...
    def grouped_id(self) -> int | None:
        ...
        ...
    @property
    def reactions(self) -> enums.MessageReactions | None:
        """
        Reactions to this message
        """
        ...
    @property
    def restriction_reason(self) -> list[enums.RestrictionReason] | None:
        """
    ...
    def effect(self) -> int | None:
        ...
        ...
    @property
    def factcheck(self) -> enums.FactCheck | None:
        """
