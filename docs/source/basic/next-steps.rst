...
automate things), you should make sure to `comply with the ToS <https://core.telegram.org/api/config#terms-of-service>`_:
...
because it should require user action.
