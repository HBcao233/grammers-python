...
.. code-block:: python
    ...
    async def main():
        ...
        # If you don't mind the data possibly being out of date,
        # you can use the "client.me" field, which automatically set up after logging in.
        # me = client.me

        # "me" is a user object. In grammers, 
        # the "__str__" method of any Telegram object is pretty-print
        # (Unlike in telethon you need manually call `me.stringify()`.)
        # If you don't need pretty-print, call `repr(me)` instead.
        print(me)
        ...
        async for message in client.iter_history_messages('me', limit=10):
...
.. important::
    ...
    Note that grammers is an asynchronous library, and as such, you should
